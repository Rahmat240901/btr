module.exports = {
    "registercommands" : false,
     "token": "ODUzNjA2MTcwMjMzNDA1NDQw.YMX0sg.osgQFngBLREhi3Rcf0u7o0G7Ohk",
...
"secret": "TKDHwzyl2iieCPgq9mp4O5gttwqEOm1c",
 "dashboardURL": "https://dyno-clone.npgop1.repl.co",
defaultjoinmessage: "{user} Joined Invited By {Inviter} (Inviter Invites: {inv})",
defaultleavemessage: "{user} Left, Invited by {inviter}",
  basiclang: "en", //Bahasa dasar bot, "fr" untuk bahasa Prancis dan "en" untuk bahasa Inggris
    embeds: {
        color: "BLUE", //Sematkan warna (dalam bahasa Inggris)
        s: "GIVEAWAY :tada: :tada:" //Embed footer
    },
    ...
    auth: {
        support: "https://discord.gg/6AExCtVEW6", //The link of your Discord server
